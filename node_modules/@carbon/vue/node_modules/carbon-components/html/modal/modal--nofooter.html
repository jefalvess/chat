...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-fzi1wgoq1ik">Show
  modal</button>

<div data-modal id="modal-fzi1wgoq1ik" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-fzi1wgoq1ik-label" aria-describedby="modal-fzi1wgoq1ik-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fzi1wgoq1ik-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fzi1wgoq1ik-heading">Modal heading</p>
