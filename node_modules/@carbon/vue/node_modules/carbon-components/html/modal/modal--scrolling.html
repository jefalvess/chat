...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mbod7g53ob">Show
  modal</button>

<div data-modal id="modal-mbod7g53ob" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mbod7g53ob-label" aria-describedby="modal-mbod7g53ob-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mbod7g53ob-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mbod7g53ob-heading">Modal heading</p>
