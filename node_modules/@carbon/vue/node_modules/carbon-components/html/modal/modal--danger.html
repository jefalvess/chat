...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-8zq11436fmb">Show
  modal</button>

<div data-modal id="modal-8zq11436fmb" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-8zq11436fmb-label" aria-describedby="modal-8zq11436fmb-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8zq11436fmb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8zq11436fmb-heading">Modal heading</p>
