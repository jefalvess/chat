...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-h2pgqzer3yi">Show
  modal</button>

<div data-modal id="modal-h2pgqzer3yi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-h2pgqzer3yi-label" aria-describedby="modal-h2pgqzer3yi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-h2pgqzer3yi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-h2pgqzer3yi-heading">Modal heading</p>
