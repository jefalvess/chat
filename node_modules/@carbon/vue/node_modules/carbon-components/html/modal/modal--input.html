...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mbfct54050o">Show
  modal</button>

<div data-modal id="modal-mbfct54050o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mbfct54050o-label" aria-describedby="modal-mbfct54050o-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mbfct54050o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mbfct54050o-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-mbfct54050o" class="bx--label">Text Input label</label>
        <input id="text-input-mbfct54050o" type="text" class="bx--text-input" placeholder="Optional placeholder text"
