...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gk5a45ff3jt">Show
  modal</button>

<div data-modal id="modal-gk5a45ff3jt" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gk5a45ff3jt-label" aria-describedby="modal-gk5a45ff3jt-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gk5a45ff3jt-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gk5a45ff3jt-heading">Modal heading</p>
