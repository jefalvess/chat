...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-n3s4ai1nrj">Show
  modal</button>

<div data-modal id="modal-n3s4ai1nrj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-n3s4ai1nrj-label" aria-describedby="modal-n3s4ai1nrj-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-n3s4ai1nrj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-n3s4ai1nrj-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
