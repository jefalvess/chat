...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pnfol1lawcl">Show
  modal</button>

<div data-modal id="modal-pnfol1lawcl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pnfol1lawcl-label" aria-describedby="modal-pnfol1lawcl-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pnfol1lawcl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pnfol1lawcl-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
