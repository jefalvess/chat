...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-c99m1tl7iap">Show
  modal</button>

<div data-modal id="modal-c99m1tl7iap" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-c99m1tl7iap-label" aria-describedby="modal-c99m1tl7iap-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-c99m1tl7iap-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-c99m1tl7iap-heading">Modal heading</p>
