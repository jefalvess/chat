...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-o79fpb0cwt">Show
  modal</button>

<div data-modal id="modal-o79fpb0cwt" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-o79fpb0cwt-label" aria-describedby="modal-o79fpb0cwt-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-o79fpb0cwt-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-o79fpb0cwt-heading">Modal heading</p>
