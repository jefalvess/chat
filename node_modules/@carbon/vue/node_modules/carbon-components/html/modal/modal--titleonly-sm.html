...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-t3fcb96t6t">Show
  modal</button>

<div data-modal id="modal-t3fcb96t6t" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-t3fcb96t6t-label" aria-describedby="modal-t3fcb96t6t-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-t3fcb96t6t-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-t3fcb96t6t-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
