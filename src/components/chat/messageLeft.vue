...
<div style="width: 100%;" > 
      ...
      <div  class="result">
          ...
          <div style="min-height: 1rem; background-color: white; margin-left: 0.5rem; margin-top: 0.5rem; padding-top: 0.5rem; padding-bottom: 0.5rem; border-radius: 25px; padding: 1rem; " class="bx--col--lg" >  {{ message.message }} </div>
      </div>
